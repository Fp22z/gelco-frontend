...
function ForgotPasswordModal({ onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    setError('');
    // Simula llamada al backend — conectar cuando exista el endpoint
      ...
      <div className="auth-page">
        ...
        <div className="auth-left">
          ...
          <div className="auth-left-content">
            <h2 className="auth-left-quote">
              Tu negocio,<br />
              en tus <em>manos</em>.<br />
              Siempre.
            </h2>
            <p className="auth-left-sub">
              Más de 3,200 consultoras en todo el Perú ya gestionan
              sus ventas, pedidos y clientes con GELCO.
            </p>
          </div>

          <div className="auth-left-stats">
            <div className="auth-stat-chip">
              <span className="auth-stat-chip-value">3.2K+</span>
              <span className="auth-stat-chip-label">Consultoras</span>
            </div>
            <div className="auth-stat-chip">
              <span className="auth-stat-chip-value">98K+</span>
              <span className="auth-stat-chip-label">Pedidos</span>
            </div>
            <div className="auth-stat-chip">
              <span className="auth-stat-chip-value">99%</span>
              <span className="auth-stat-chip-label">Satisfacción</span>
            </div>
          </div>
          ...
          <div className="auth-testimonial">
            ...
            <p className="auth-testimonial-text">
              "Con GELCO mis ventas subieron 40% en dos campañas.
              Ahora manejo todo desde el celular."
            </p>
          ...
          <div className="auth-form-wrap">
            ...
            <div className="auth-form-header">
              ...
              <h1 className="auth-form-title">
                Inicia <em>sesión</em><br />en tu cuenta
              </h1>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <button type="submit" className="auth-btn-submit" disabled={loading}>
                {loading
                  ...
                  : <>Ingresar al sistema <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg></>
                }
              </button>
            </form>
            ...
            <div className="auth-footer">
              <p className="auth-footer-text">
                ...
                <Link to="/register" className="auth-footer-link">Regístrate gratis →</Link>
              </p>
            </div>
          </div>
        </div>
